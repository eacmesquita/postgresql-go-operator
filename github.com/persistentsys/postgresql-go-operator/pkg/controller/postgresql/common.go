...
import (
	...
	"github.com/persistentsys/postgresql-go-operator/pkg/resource"
	"github.com/persistentsys/postgresql-go-operator/pkg/service"
...
func (r *ReconcilePostgreSQL) ensureDeployment(request reconcile.Request,
...
func (r *ReconcilePostgreSQL) ensureService(request reconcile.Request,
	instance *postgresqlv1alpha1.PostgreSQL,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *ReconcilePostgreSQL) ensureSecret(request reconcile.Request,
	instance *postgresqlv1alpha1.PostgreSQL,
	s *corev1.Secret,
) (*reconcile.Result, error) {
	found := &corev1.Secret{}
...
func (r *ReconcilePostgreSQL) ensurePV(request reconcile.Request,
	instance *postgresqlv1alpha1.PostgreSQL,
) (*reconcile.Result, error) {
	pvName := resource.GetPostgresqlVolumeName(instance)
	...
	if err != nil && errors.IsNotFound(err) {
		...
		pv := resource.NewPostgreSqlPV(instance, r.scheme)
...
func (r *ReconcilePostgreSQL) ensurePVC(request reconcile.Request,
	instance *postgresqlv1alpha1.PostgreSQL,
) (*reconcile.Result, error) {
	pvcName := resource.GetPostgresqlVolumeClaimName(instance)
	...
	if err != nil && errors.IsNotFound(err) {
		...
		pvc := resource.NewPostgreSqlPVC(instance, r.scheme)
