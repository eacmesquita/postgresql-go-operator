...
func FetchDatabaseCR(name, namespace string, client client.Client) (*v1alpha1.PostgreSQL, error) {
...
// FetchBackupCR fetches CR of PostgreSQL Backup object
...
// func FetchDatabasePod(bkp *v1alpha1.Backup, db *v1alpha1.PostgreSQL, client client.Client) (*corev1.Pod, error) {
...
// func FetchDatabaseService(bkp *v1alpha1.Backup, db *v1alpha1.PostgreSQL, client client.Client) (*corev1.Service, error) {
...
// func FetchDatabaseBackupService(bkp *v1alpha1.Backup, db *v1alpha1.PostgreSQL, client client.Client) (*corev1.Service, error) {
...
// func buildDatabaseCriteria(bkp *v1alpha1.Backup, db *v1alpha1.PostgreSQL) *client.ListOptions {
// 	labelSelector := labels.SelectorFromSet(utils.Labels(db, "postgresql"))
// 	listOps := &client.ListOptions{Namespace: db.Namespace, LabelSelector: labelSelector}
// 	return listOps
// }

// buildDatabaseCreteria returns client.ListOptions required to fetch the secondary resource created by
// func buildDatabaseBackupCriteria(bkp *v1alpha1.Backup, db *v1alpha1.PostgreSQL) *client.ListOptions {
// 	labelSelector := labels.SelectorFromSet(utils.Labels(db, "postgresql-backup"))
